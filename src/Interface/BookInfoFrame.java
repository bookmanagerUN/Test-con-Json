...
public class BookInfoFrame extends javax.swing.JFrame {
    ...
    public BookInfoFrame(Book book, MyBooks myBooks, FrameStack frameStack, UserFinal user) {
        ...
        UtilInterface.printImage(this.JLProyectIcon2, "src/Interface/MediaFiles/VAzul1.png", this);
    ...
    public BookInfoFrame() {
        ...
        initComponents();
        //print logo
        UtilInterface.printImage(JLProyectIcon2, "src/Interface/MediaFiles/VAzul1.png", this);
        //escribe el nombre del libro en el JPanel
    ...
    private void initComponents() {
        ...
        jPNewBook2Layout.setVerticalGroup(
            ...
            .addGroup(jPNewBook2Layout.createSequentialGroup()
                ...
                .addGroup(jPNewBook2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jBForward, javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jBBack))
                .addContainerGap())
        );
