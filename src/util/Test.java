...
public class Test {
    public static void main(String[] args) throws IOException {
        //Creando libros
        /*
        BookInformation informacion1 = new BookInformation( "Caperucita",
                "anonimo", "fabula", "222200");
        BookNotes nota1 = new BookNotes();
        Book libro1 = new Book(informacion1, nota1, 0, true, "etrytr",);
        libro1.getNotes().addNote(new Notes("17/08/2019", 69, 3, "nota 1"));
        libro1.getNotes().addNote(new Notes("19/06/2020", 23, 3, "Nota 2"));

        LinkedList<Book> listaLibros = new LinkedList<>();

        BookInformation informacion2 = new BookInformation( "Principito",
                "anonimo", "Historia", "22110");
        BookNotes nota2 = new BookNotes();
        ...
        BookInformation informacion3 = new BookInformation("La biblia",
                "Diosito", "Religion", "3335");
        BookNotes nota3 = new BookNotes();
